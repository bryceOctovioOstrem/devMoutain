...
//CODE HERE
 function compareNums(numberOne, numberTwo){
  if(numbersOne > numberTwo){
...
//CODE HERE
function adder (numberOne, numberTwo){
 Number(numberOne);
 Number(numberTwo)
...
function theEliminator(contestants, loser){
  for(let b =0; b<contestants.length;b++){
    if(contestants[b] === loser){
